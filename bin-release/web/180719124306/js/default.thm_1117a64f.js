window.skins={};
	...
	function HeroItem() {
		_super.call(this);
		this.skinParts = ["cbox_selected"];
		
		this.elementsContent = [this._Image1_i(),this.cbox_selected_i(),this._Image2_i(),this._Label1_i(),this._Label2_i()];
	...
	_proto.cbox_selected_i = function () {
		var t = new eui.CheckBox();
		this.cbox_selected = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		t.label = "";
		t.top = 28;
